...
<script>
    ...
    if (mensaje === "campos_vacios") {
        Swal.fire({
            title: `<span class="titulo-advertencia">Advertencia</span>`,
            html: `
        ...
        Swal.fire({
            title: `<span class="titulo-alerta titulo-error">Error</span>`,
            html: `
                <div class='custom-alert'>
                    <div class='alerta'>
                        <div class='contenedor-imagen'>
        ...
        Swal.fire({
            title: `<span class="titulo-error titulo-advertencia">Error</span>`,
            html: `
                <div class='custom-alert'>
                    <div class='alerta'>
                        <div class='contenedor-imagen'>
