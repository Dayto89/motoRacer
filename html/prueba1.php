    ...
    <div class="container">
        ...
        <form name="formulario" method="post" action="">
            ...
            <div class="campo"><label for="nueva_contrasena">Nueva Contraseña:</label>
                ...
                <ul id="password-requisitos" class="requisitos">
                ...
                <p id="mensaje-seguridad" style="display:none; font-weight:bold; color:green;">✔ Contraseña segura</p>

                <i id="togglePassword"
                    class='bx bx-hide'
                    style="position: absolute; right: 12rem; left: 15rem; top: 17%; transform: translateY(-50%); cursor: pointer; color:black; font-size: 1.5rem; width: 20px; height: 20px;">
                </i>
            </div>
