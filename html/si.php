...
<body>
  ...
  <div class="main-content">
    ...
    <div class="barra-superior">
      ...
      <input type="text" id="barraReportes" name="valor" placeholder="Buscar en resultados.. ">
    ...
    <div id="filtros-popup" class="filtros-popup">
      <div class="filtros-container">
          ...
          <div class="form-group">
            <label>Desde: <input type="date" id="fDesde" style="font-family: Arial, Helvetica, sans-serif;     height: 26px; border-radius:10px;border:none;"></label>
            <label>Hasta: <input type="date" id="fHasta" style="font-family: Arial, Helvetica, sans-serif;    height: 26px; border-radius:10px;border:none;"></label>
          </div>

          <!-- Estado activo/inactivo -->
          <div class="form-group">
            <label>Estado:
              <select id="fActivo" style="  height: 26px; border-radius:10px;border:none;">
          ...
          <div class="form-group">
            ...
            <select id="fPago " name="fPago"  style="  height: 26px; border-radius:10px;border:none;">
              <option value="all">Todos</option>
  ...
  <div class="table-wrapper">
    <?php if (mysqli_num_rows($resultado) > 0): ?>
      <table id="facturaTable" class="tabla-centrada">
        <thead>
          <tr>
            <th>Código</th>
  ...
  <script>
    // Sobrescribimos Swal.fire con un mixin que aplica tu diseño a TODOS los alertas:
    Swal = Swal.mixin({
      background: '#ffffffdb',
