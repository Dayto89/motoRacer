...
/* Estilo general del cuadro de diálogo */
.mi-popup {
...
/* Estilo para el título de éxito */
.mi-titulo {
...
/* Estilo para el título de error */
.mi-titulo-error {
  font-family: "Poppins", sans-serif;
  font-size: 22px;
  font-weight: bold;
      ...
      if (data.success) {
        ...
        Swal.fire({
          ...
          customClass: {
            ...
            htmlContainer: "mi-texto",
            confirmButton: "mi-boton-cancelar"
          },
